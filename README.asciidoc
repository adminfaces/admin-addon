...
jpa-setup --persistence-unit-name adminPU --jpaVersion 2.1 --provider Hibernate --container WILDFLY --db-type H2 --data-source-name java:jboss/datasources/ExampleDS ;
