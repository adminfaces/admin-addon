...
/**
 * A template processor that processes specified Freemarker files to generate
 * text output.
 *
 */
public class FreemarkerTemplateProcessor {
    ...
    /**
     * Provides a {@link Template} representation of a Freemarker template
     * present at a specified location.
     *
     * @param templateLocation The location of the template relative to the
     * classpath
     * @return The Freemarker {@link Template} instance for the specified
     * location
     */
